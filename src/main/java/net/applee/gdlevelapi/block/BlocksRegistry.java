package net.applee.gdlevelapi.block;

import lombok.Getter;
import net.applee.gdlevelapi.block.blocks.Block;
import net.applee.gdlevelapi.block.blocks.UnknownBlock;
import net.applee.gdlevelapi.block.blocks.triggers.*;
import net.applee.gdlevelapi.block.blocks.triggers.spawnable.*;
import net.applee.gdlevelapi.block.blocks.triggers.spawnable.todo.*;
import net.applee.gdlevelapi.block.blocks.triggers.spawnable.todo.effects.block_enter.*;
import net.applee.gdlevelapi.block.blocks.triggers.spawnable.todo.effects.enter.*;
...
public class BlocksRegistry {
	...
	public static void init() {
		...
		register(BlockEnterEffectTrigger_22.class, BlockEnterEffectTrigger_22::new, 22);
		register(DownBlockEnterEffectTrigger.class, DownBlockEnterEffectTrigger::new, 23);
		register(UpBlockEnterEffectTrigger.class, UpBlockEnterEffectTrigger::new, 24);
		register(LeftBlockEnterEffectTrigger.class, LeftBlockEnterEffectTrigger::new, 25);
		register(RightBlockEnterEffectTrigger.class, RightBlockEnterEffectTrigger::new, 26);
		register(BlockEnterEffectTrigger_27.class, BlockEnterEffectTrigger_27::new, 27);
		register(BlockEnterEffectTrigger_28.class, BlockEnterEffectTrigger_28::new, 28);
		register(BlockEnterEffectTrigger_55.class, BlockEnterEffectTrigger_55::new, 55);
		register(BlockEnterEffectTrigger_56.class, BlockEnterEffectTrigger_56::new, 56);
		register(BlockEnterEffectTrigger_57.class, BlockEnterEffectTrigger_57::new, 57);
		register(BlockEnterEffectTrigger_58.class, BlockEnterEffectTrigger_58::new, 58);
		register(BlockEnterEffectTrigger_59.class, BlockEnterEffectTrigger_59::new, 59);
		register(BlockEnterEffectTrigger_1915.class, BlockEnterEffectTrigger_1915::new, 1915);
	...
	public static Block create(Map<String, String> rawData) {
		...
		block.readRawProperties(rawData);
		return block;
	}
